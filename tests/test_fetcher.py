...
from meteobeguda.fetcher import URL_TWO_DAYS, URL_EIGHT_DAYS, get_last_two_days, get_last_eight_days


@pytest.mark.parametrize("url,method", [(URL_TWO_DAYS, get_last_two_days), (URL_EIGHT_DAYS, get_last_eight_days)])
